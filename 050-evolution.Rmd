...
```{r}
embed_video(
  "https://s3-eu-west-1.amazonaws.com/media.pmcharrison.com/music/animals/snowball.mp4", width = "100%",
  title = "Snowball the parrot dancing to music.", credit = "@patel2009"
)
...
```{r}
embed_youtube_video("BI851yJUQQw", title = "A Maori 'Haka' dance.", width = "100%")
```
